...
- **NEXT UP**: **KB-WP-01**(공개 규정 Clause/Chunk Pack 계약·로더·가드 — ADR-013, 인박스 keyword-only·원문 repo 미포함). WP 시퀀스 = KB-WP-01→KB-WP-02→FEEDBACK-WP-01(ADR-014, RETRIEVAL)→FEEDBACK-WP-02. **STAB-WP-05 인증서 경로 = A(사내 Enterprise CA) 확정**(구현 WP는 시퀀스 뒤). 실 Test PC Gate B/C = BLOCKED(`docs/48`).
