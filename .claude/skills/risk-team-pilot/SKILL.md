...
## 절대 원칙
- **Gate B/C 봉인 선행**: Gate B 적용 대상 전 항목 PASS(명시 N/A 수용 포함) + Gate C(C5는 서명본 또는 미서명 `ACCEPTED_RISK` 서면 수용) 없이 파일럿 Go 금지(`docs/41 §4·§5`, 현재 `docs/54`; `docs/48/45/44` historical).
...
- 보고 예: `Pilot Go/No-Go = NO-GO (BLOCKED: v0.7.1 적용 대상 Gate B/C 증거 미봉인, Pilot Kit 미완) — 선행 작업: docs/54 실행`.

## 참조
- `docs/41 §4·§5`(Pilot Gate B/C·Readiness Checklist) · `docs/54`(현재 v0.7.1 Gate B/C 증거 원장·런북) · `docs/48/45/44`(historical)
