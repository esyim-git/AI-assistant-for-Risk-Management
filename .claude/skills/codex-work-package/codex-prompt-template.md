...
- 작은 Diff. main 직접 push 금지·force push 금지(`docs/32`·`docs/35`, [/branch-governance](../branch-governance/SKILL.md)).
...
- 검토는 [/codex-result-review](../codex-result-review/SKILL.md), 게이트 A는 [/security-gate-a](../security-gate-a/SKILL.md)로 연결된다.
