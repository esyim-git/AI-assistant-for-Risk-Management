---
name: codex-work-package
description: "단일 Work Package + Codex 프롬프트 작성 — docs/39 WP 14필드 형식으로 WP 1개만, 결과 Codex 프롬프트는 prompts/codex/<WP-ID>_*.md 에 출력한다. NEXT UP WP 계획·Codex 구현단위 분해 시 사용."
...
- [/project-status-sync](../project-status-sync/SKILL.md)가 확정한 NEXT UP을 이어받아 구현 착수할 때.
...
- 관련 스킬: [/project-status-sync](../project-status-sync/SKILL.md)(NEXT UP 확정) → [/codex-result-review](../codex-result-review/SKILL.md)(결과 검토) · [/branch-governance](../branch-governance/SKILL.md)(브랜치/PR 규약) · [/security-gate-a](../security-gate-a/SKILL.md)(보안 게이트 A)
