...
- [ ] 보안 축 통과: `/security-gate-a`(Gate A, `docs/28`) — NuGet 0·외부 API 0·민감정보 0
- [ ] 4축 리뷰 통과: `/codex-result-review`(Diff·보안·테스트·문서)
...
- [ ] `/documentation-truth-sync`로 `docs/38`(Roadmap·Traceability)·`docs/39`(Resume Brief 기준선 SHA·NEXT UP·Total)·`docs/40`(ADR)·`docs/45`(Gate 증거) 갱신
...
- 문서 정합     : PASS | 후속(/documentation-truth-sync)
...
- 연계 스킬: `/security-gate-a` · `/codex-result-review` · `/documentation-truth-sync`.
