---
name: data-limit-review
description: "리스크 데이터/한도 로직 리뷰 — ColumnMapping(승인형)·LimitMonitor 6상태·대사 9종·DEMO_ONLY/합성한도 금지·실데이터/실컬럼명 repo 미포함. Risk/Mapping/Data 파일 작업 시 자동 적용."
...
- 연계 스킬: `/risk-analytics-design`, `/security-gate-a`
