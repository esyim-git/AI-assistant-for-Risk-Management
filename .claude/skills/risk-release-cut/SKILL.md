...
6. **릴리스 문서**: `docs/4x_Release_vX.Y.Z.md`(릴리스 노트 + 패키징 런북 + Gate B 체크리스트) 작성. Gate B/C 증거 문서는 `docs/48` 양식 재사용, 초기 상태 = BLOCKED.
...
## 참조
- `docs/24_Release_Packaging_Guide.md` · `docs/34_Release_Rehearsal_Guide.md` · `docs/42`/`docs/43`/`docs/47`(v0.5/0.6/0.7 릴리스 실례) · `docs/48`(Gate B/C 증거 양식·라운드 규약)
