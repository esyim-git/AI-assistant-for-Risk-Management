...
| C-13 | Risk Semantic Hardening | R2-WP-01 | 중복키 차단(DUPLICATE_LIMIT)·통화/단위 ColumnMapping·RECON_UNIT 활성·BASE_DT 검증/정규화·Join Audit | Data | **PARTIAL**(Codex branch `feature/r2-wp-01-semantic-hardening`, local-gate `Total=666 PASS=666 FAIL=0`; Claude review/merge pending) |
