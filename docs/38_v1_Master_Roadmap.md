...
> **현재 기준선 = v0.6.0 + STAB-WP-01~04 + STAB-UX-01/02 + UX-WP-01~03 + R2-WP-01~04** (main `35e6f01`, PR #87 머지 후; **R2 분석 트랙(v0.7.0) 완결**, 정식 v0.7.0 태깅 미수행). 본 문서는 v0.6.0 다음 단계부터 v1.0 Team Pilot까지의 통합 실행 로드맵이다.
