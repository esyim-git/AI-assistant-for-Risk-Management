...
- **SmokeTest**: **Total=698 PASS=698 FAIL=0** (정본 합계 — R2-WP-03(#84) 후 `9bc83a3` 직접 local-gate 재확인: `dotnet build` 0/0 + SmokeTest, 2026-06-30). 이력: 513(STAB-WP-02) → 572(STAB-WP-03b +59) → 579(STAB-UX-01 +7) → 602(UX-WP-01 +23) → 631(UX-WP-02/03 +29) → 646(STAB-UX-02 +15) → 671(R2-WP-01 +25) → 680(R2-WP-02 +9) → 698(R2-WP-03 +18). 과거 484/502는 하니스가 합계를 안 찍던 시절의 미집계 추정치였고, STAB-WP-02가 **합계·도메인별 PASS/FAIL·실행시간**을 출력한다.
...
| C-16 | Visualization/Report(인박스 차트·Heatmap·TopN·집중도·정확 Exception Count) | R2-WP-04 | 정확 Exception Count(Number SoT)·신규 RISK_VISUAL 시트 배선·TopN/집중도 결정성·Heatmap 등급·NuGet 0 (`ReportTests` +16) | Data | **PARTIAL**(Codex local-gate candidate: `dotnet build` 0/0, SmokeTest `Total=714 PASS=714 FAIL=0`, Unclassified=0, PackageReference 0; Claude review/merge pending; 실 Test PC Gate B/C BLOCKED) |
