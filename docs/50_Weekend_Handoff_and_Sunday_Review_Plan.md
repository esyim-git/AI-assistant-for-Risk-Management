...
> **기준선(갱신)**: main `0f6e1d7`(VERSION 0.7.0, UX-WP-09 #113 머지 후), 정본 SmokeTest `Total=834 PASS=834 FAIL=0`, NEXT UP=확장 트랙 Wave 1(QA-WP-01·QA-WP-02·UX-WP-10 병렬 — Codex 실행 대기). Gate B/C 실 Test = user-driven(`docs/48 §B″` 실행 런북 참조).
