...
- **완료조건**: 3파일 범프 + build 0/0 + `Total=714` 불변 + build/03 PASS(미서명 portable ZIP/SHA256/ReleaseNote-v0.7.0/DependencyList NuGet=0). 태그 `v0.7.0`은 Local(웹 프록시 태그 push 403).
