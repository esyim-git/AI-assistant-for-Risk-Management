...
| **R3-WP-05** | **NCR Rule Set 구조**(`docs/08` 심화) | **DONE** | Rule Set 8요소 구조·`config/ncr` safe fallback 로더·조회전용 SQL 검증·검토용 초안 설명. **모델 산식 암기 0** · NCR 공식본 원문 repo 미포함. SmokeTest 460 PASS |
